...
interface CourtIndexPageProps {
    data: Array<CourtListProps>,
    currentUser: { data: UserListProps } | null,
}

const Index = ({ data, currentUser } : CourtIndexPageProps) => {
    return (
        <Layout currentUser={currentUser?.data}>
            <Head title={'Court List'} />

            <Breadcrumb paths={['courts']} />

            <Link
                href={route('courts.create', undefined, undefined, undefined)}
                        ...
                        { data.map(function (court, index){
                            return (
                                <tr key={index}>
                                    ...
                                    <td className="border-b border-[#eee] py-5 px-4 dark:border-strokedark">
                                        <p className="text-black dark:text-white">{court.location}</p>
                                    </td>
                                    <td className="border-b border-[#eee] py-5 px-4 dark:border-strokedark">
                                        <div className="flex items-center space-x-3.5">
                                            <Link className="hover:text-primary" href={route('courts.show', court.id, undefined, undefined)}>
                                                <svg
                                            ...
                                            <Link className="hover:text-primary"
                                                  href={route('courts.edit', court.id, undefined, undefined)}>
                                                <svg
                                                    className="fill-current"
                                                    width="18"
                                                    height="18"
                                            ...
                                            <Link className="hover:text-primary"
                                                  href={route('courts.delete', court.id, undefined, undefined)}
                                                  method="delete"
                                                  as="button"
                                                  type="button">
                                                <svg
