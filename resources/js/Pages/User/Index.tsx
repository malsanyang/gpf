...
const Index = ({ data, currentUser } : UserIndexPageProps) => {
    return (
        <Layout currentUser={currentUser?.data}>
            <Head title={'User List'} />

            <Breadcrumb paths={['user-management', 'users']} />

            <Link
                href={route('users.create', undefined, undefined, undefined)}
                                ...
                                <tr key={index}>
                                    ...
                                    <td className="border-b border-[#eee] py-5 px-4 dark:border-strokedark">
                                        <div className="flex items-center space-x-3.5">
                                            <Link className="hover:text-primary" href={route('users.show', user.id, undefined, undefined)}>
                                                <svg
                                            ...
                                            <Link className="hover:text-primary"
                                                href={route('users.edit', user.id, undefined, undefined)}>
                                                <svg
                                                    className="fill-current"
                                                    width="18"
                                                    height="18"
                                            ...
                                            <Link className="hover:text-primary"
                                                href={route('users.delete', user.id, undefined, undefined)}
                                                method="delete"
                                                as="button"
                                                type="button">
                                                <svg
