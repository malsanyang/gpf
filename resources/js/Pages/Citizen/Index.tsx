...
interface CitizenIndexPageProps {
    data: Array<CitizenListProps>,
    currentUser: { data: UserListProps } | null,
}

const Index = ({ data, currentUser } : CitizenIndexPageProps) => {
    return (
        <Layout currentUser={currentUser?.data}>
            <Head title={'Citizen List'} />

            <Breadcrumb paths={['citizens']} />

            <Link
                href={route('citizens.create', undefined, undefined, undefined)}
            ...
            <div className="w-full max-w-full rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
                <div className="max-w-full overflow-x-auto">
                    <table className="w-full table-auto">
                        ...
                        { data.map(function (citizen, index){
                            return (
                                <tr key={index}>
                                    ...
                                    <td className="border-b border-[#eee] py-5 px-4 dark:border-strokedark">
                                        <div className="flex items-center space-x-3.5">
                                            <Link className="hover:text-primary" href={route('citizens.show', citizen.id, undefined, undefined)}>
                                                <svg
                                            ...
                                            <Link className="hover:text-primary"
                                                  href={route('citizens.edit', citizen.id, undefined, undefined)}>
                                                <svg
                                                    className="fill-current"
                                                    width="18"
                                                    height="18"
                                            ...
                                            <Link className="hover:text-primary"
                                                  href={route('citizens.delete', citizen.id, undefined, undefined)}
                                                  method="delete"
                                                  as="button"
                                                  type="button">
                                                <svg
